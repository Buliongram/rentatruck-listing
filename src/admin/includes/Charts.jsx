...
export default function Charts({ agents }) {
  ...
  return (
    <section className="flex gap-4">
      <article className="p-6 rounded-3xl flex flex-col w-full gap-4 h-max bg-white">
          ...
          {agents.map((agent, index) => (
            <main className="flex items-center justify-between">
              ...
              <div className="flex flex-col items-center">
                ...
                <p className="text-[11px] text-zinc-500">Total Listing</p>
              </div>
              <div className="flex flex-col items-center">
                <h3 className="text-xs font-semibold">{agent.country}</h3>
