    ...
    <>
      <section className="flex flex-col items-center gap-8 lg:p-14 p-4">
        <article className="flex flex-col items-center gap-2">
          <h2 className="text-xl lg:text-3xl font-semibold text-primary">
            Need Assistance?
          </h2>
          <p className="text-zinc-500 text-sm text-center font-normal">
          ...
          <form action="" className="flex items-center gap-2 w-full">
            <input
              ...
              required
              name="firstname"
              className="bg-white border border-zinc-200 w-full rounded-xl p-3 px-4 text-xs font-medium placeholder:text-xs placeholder:text-zinc-600 placeholder:font-normal outline-zinc-200 "
        ...
        <article className="flex w-full gap-4">
          <section className="flex flex-col gap-1 border border-zinc-300 bg-white  rounded-3xl p-6 w-full">
            <span className="h-10 w-10 rounded-lg bg-sky-900/5 border border-zinc-300 flex items-center justify-center text-primary text-lg">
          ...
          <section className="flex flex-col gap-3 w-full divide-y divide-zinc-300">
            {neighborhoodFaqs.map((faq, index) => (
              <main key={index} className="py-2">
                ...
                <p
                  className={`overflow-hidden transition-all text-xs text-zinc-500 duration-300 font-normal ${
