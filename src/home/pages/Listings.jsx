            ...
            <div className="flex items-center p-1 rounded-2xl w-max text-xs border-[1.5px] border-zinc-950">
              <span
                ...
                className={`rounded-xl px-6 py-1.5 cursor-pointer transition duration-200 ${
                  !filters.purpose ? "bg-primary text-white" : "hover:bg-white"
                }`}
              >
                All
              </span>
              <span
                onClick={() => setFilters({ ...filters, purpose: "For Sale" })}
                className={`rounded-xl px-6 py-1.5 cursor-pointer transition duration-200 ${
              ...
              <span
                onClick={() => setFilters({ ...filters, purpose: "For Rent" })}
                className={`rounded-xl px-6 py-1.5 cursor-pointer transition duration-200 ${
              ...
              <span
                onClick={() => setFilters({ ...filters, purpose: "Short Let" })}
                className={`rounded-xl px-6 py-1.5 cursor-pointer transition duration-200 ${
