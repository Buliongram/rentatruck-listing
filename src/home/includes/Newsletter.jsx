...
export default function Newsletter() {
  return (
    <article className="p-8 py-12 lg:p-28 lg:py-14">
      <section className="h-[300px] lg:h-[350px] flex flex-col items-center justify-evenly p-5 lg:p-10 relative rounded-3xl bg-black">
        <img
          src={banner}
          className="absolute top-0 left-0 w-full h-full object-cover opacity-80 rounded-3xl"
          alt="banner"
        />
